...
function App() {
  //Instance ID a
  let InstanceId_Widget = "840469";  
  let InstanceId_QA = "841160";
  let InstanceId_SEO = "841155";
  let InstanceId_Carousel = "841159";
  let InstanceId_StarRating = "841132";
  let InstanceId_PromotedProd = ""; 
  let InstanceId_UgcGallery = "";  
  let InstanceId_ReviewsTab = "841156"; 
