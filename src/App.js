...
function App() { 
  //Instance ID a
  let InstanceId_Widget = "1060976";  
  let InstanceId_QA = "703714"; 
  let InstanceId_SEO = "";
  let InstanceId_Carousel = "778564";
  let InstanceId_StarRating = "703705";
  let InstanceId_PromotedProd = "1060965"; 
  let InstanceId_UgcGallery = ""; 
  let InstanceId_ReviewsTab = "1063109"; 
